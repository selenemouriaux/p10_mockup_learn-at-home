...
` +
    ...
    var Dn = {
      ...
      Fn = j(Pn),
      In = j(h({}, Pn, { dataTransfer: 0 })),
      Ln = j(h({}, kn, { relatedTarget: 0 })),
      Rn = j(h({}, Dn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
      zn = j(
        h({}, Dn, {
    ...
    var Kn = j(
      ...
      Yn = j(h({}, Dn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Xn = j(
        h({}, Pn, {
          deltaX: function (e) {
            return `deltaX` in e
      ...
      Zn = j(h({}, Dn, { newState: 0, oldState: 0 })),
      Qn = [9, 13, 27, 32],
...
`
  ...
  _ = `modulepreload`,
  v = function (e) {
    return `/p10_mockup_learn-at-home/` + e;
  },
  y = {};
...
var Fe = x.createContext(null);
(Fe.displayName = `DataRouterState`), x.createContext(!1);
var Ie = x.createContext({ isTransitioning: !1 });
Ie.displayName = `ViewTransition`;
var Le = x.createContext(new Map());
...
var Ve = x.createContext({ outlet: null, matches: [], isDataRoute: !1 });
Ve.displayName = `Route`;
var He = x.createContext(null);
He.displayName = `RouteError`;
function Ue(e, { relative: t } = {}) {
  C(We(), `useHref() may be used only in the context of a <Router> component.`);
  let { basename: n, navigator: r } = x.useContext(ze),
    { hash: i, pathname: a, search: o } = Ye(e, { relative: t }),
    s = a;
  return (
    n !== `/` && (s = a === `/` ? n : Ae([n, a])),
...
function qe() {
  let { isDataRoute: e } = x.useContext(Ve);
  return e ? ft() : Je();
}
function Je() {
  C(
  ...
  let e = x.useContext(k),
    { basename: t, navigator: n } = x.useContext(ze),
    { matches: r } = x.useContext(Ve),
    { pathname: i } = A(),
  ...
  return (
    ...
    x.useCallback(
      (r, s = {}) => {
        if ((w(o.current, Ge), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
...
function Ze(e, t, n, r, i) {
  ...
  let { navigator: a } = x.useContext(ze),
    { matches: o } = x.useContext(Ve),
    s = o[o.length - 1],
    c = s ? s.params : {},
    l = s ? s.pathname : `/`,
    u = s ? s.pathnameBase : `/`,
...
var $e = x.createElement(Qe, null),
  et = class extends x.Component {
    constructor(e) {
      super(e),
        (this.state = {
          location: e.location,
...
function tt({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    x.createElement(Ve.Provider, { value: e }, n)
  );
}
function nt(e, t = [], n = null, r = null, i = null) {
  if (e == null) {
    if (!n) return null;
      ...
      h = () => {
        ...
        return (
          (t = u
            ...
            ? p
            : i.route.Component
            ? x.createElement(i.route.Component, null)
            : i.route.element
            ? i.route.element
            : e),
          x.createElement(tt, {
...
function lt() {
  return at(`useNavigation`).navigation;
}
function ut() {
...
x.memo(ht);
function ht({ routes: e, future: t, state: n, unstable_onError: r }) {
  return Ze(e, void 0, n, r, t);
}
function gt({ to: e, replace: t, state: n, relative: r }) {
  ...
  let { static: i } = x.useContext(ze);
  w(
    !i,
    `<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`
  );
  let { matches: a } = x.useContext(Ve),
    { pathname: o } = A(),
    s = qe(),
  ...
  return (
    ...
    p == null
      ...
      : x.createElement(
          ze.Provider,
          { value: s },
          x.createElement(Be.Provider, { children: t, value: p })
        )
  );
}
...
function Nt(e, t) {
  ...
  if (Tt(e)) {
    ...
    (r = o ? Ce(o, t) : null),
      ...
      (i = Mt(e.getAttribute(`enctype`)) || St),
      (a = new FormData(e));
  } else if (wt(e) || (Et(e) && (e.type === `submit` || e.type === `image`))) {
    let o = e.form;
    if (o == null)
      throw Error(
    ...
    if (
      ...
      (i =
        Mt(e.getAttribute(`formenctype`)) ||
        Mt(o.getAttribute(`enctype`)) ||
        St),
      (a = new FormData(o, e)),
      !At())
    ) {
...
function Wt(e, t) {
  let n = new Set(),
    r = new Set(t);
  return e.reduce((e, i) => {
    if (t && !Lt(i) && i.as === `script` && i.href && r.has(i.href)) return e;
    let a = JSON.stringify(Ut(i));
...
function Jt() {
  let e = x.useContext(qt);
  return (
    Pt(e, `You must render this element inside a <HydratedRouter> element`), e
  );
}
function Yt(e, t) {
...
function Zt({ page: e, ...t }) {
  let { router: n } = Gt(),
    r = x.useMemo(() => se(n.routes, e, n.basename), [n.routes, e, n.basename]);
  return r ? x.createElement($t, { page: e, matches: r, ...t }) : null;
}
function Qt(e) {
  let { manifest: t, routeModules: n } = Jt(),
    [r, i] = x.useState([]);
  return (
    x.useEffect(() => {
      let r = !1;
...
function $t({ page: e, matches: t, ...n }) {
  let r = A(),
    { manifest: i, routeModules: a } = Jt(),
    { basename: o } = Gt(),
    { loaderData: s, matches: c } = Kt(),
    l = x.useMemo(() => Bt(e, t, c, i, r, `data`), [e, t, c, i, r]),
    u = x.useMemo(() => Bt(e, t, c, i, r, `assets`), [e, t, c, i, r]),
    d = x.useMemo(() => {
  ...
  return x.createElement(
    ...
    p.map(({ key: e, link: t }) =>
      x.createElement(`link`, { key: e, nonce: n.nonce, ...t })
    )
  );
}
function en(...e) {
...
var tn =
  ...
  window.document.createElement !== void 0;
try {
  tn && (window.__reactRouterVersion = `7.9.5`);
} catch {}
function nn({ basename: e, children: t, window: n }) {
  let r = x.useRef();
  r.current ??= S({ window: n, v5Compat: !0 });
  let i = r.current,
    [a, o] = x.useState({ action: i.action, location: i.location }),
    s = x.useCallback(
      (e) => {
        x.startTransition(() => o(e));
      },
      [o]
    );
  return (
...
function rn({ basename: e, children: t, history: n }) {
  let [r, i] = x.useState({ action: n.action, location: n.location }),
    a = x.useCallback(
      (e) => {
        x.startTransition(() => i(e));
      },
      [i]
    );
  return (
    x.useLayoutEffect(() => n.listen(a), [n, a]),
    x.createElement(vt, {
      basename: e,
      children: t,
      location: r.location,
...
var an = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  on = x.forwardRef(function (
    ...
    let { basename: p } = x.useContext(ze),
      m = typeof c == `string` && an.test(c),
      h,
      g = !1;
    if (typeof c == `string` && m && ((h = c), tn))
      try {
    ...
    return v && !m
      ? x.createElement(x.Fragment, null, C, x.createElement(Zt, { page: _ }))
      : C;
  });
on.displayName = `Link`;
var sn = x.forwardRef(function (
  {
    "aria-current": e = `page`,
    caseSensitive: t = !1,
    className: n = ``,
  ...
  let u = Ye(a, { relative: c.relative }),
    d = A(),
    f = x.useContext(Fe),
...
function ln({ getKey: e, storageKey: t, ...n }) {
  ...
  return x.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${JSON.stringify(t || vn)}, ${JSON.stringify(s)})`,
    },
  });
}
...
function gn() {
  ...
  return x.useCallback(
    async (r, i = {}) => {
      let { action: a, method: o, encType: s, formData: c, body: l } = Nt(r, t);
      if (i.navigate === !1) {
        let t = i.fetcherKey || hn();
  ...
  x.useEffect(
    ...
    Sn(
      x.useCallback(() => {
        ...
        try {
          sessionStorage.setItem(t || vn, JSON.stringify(yn));
        } catch (e) {
          w(
            !1,
...
var wn = o((e) => {
  ...
  En = c(g(), 1),
  j = c(Tn(), 1);
function Dn({ onLogin: e }) {
  let [t, n] = (0, x.useState)(``),
    [r, i] = (0, x.useState)(``),
    [a, o] = (0, x.useState)(`student`);
  return (0, j.jsx)(`div`, {
    ...
    children: (0, j.jsxs)(`div`, {
      ...
      children: [
        (0, j.jsxs)(`div`, {
          ...
          children: [
            (0, j.jsx)(`div`, {
              className: `inline-flex items-center justify-center w-20 h-20 bg-indigo-600 rounded-2xl mb-4`,
        ...
        (0, j.jsx)(`p`, {
          ...
          children: `Une plateforme de soutien scolaire à distance`,
        }),
      ],
    }),
  });
...
function On() {
  return (0, j.jsx)(`div`, {
    className: `min-h-screen bg-gradient-to-br from-indigo-100 via-white to-purple-100 flex items-center justify-center p-4`,
    children: (0, j.jsxs)(`div`, {
      className: `max-w-md w-full`,
      children: [
        (0, j.jsxs)(`div`, {
                ...
                (0, j.jsxs)(`div`, {
                  children: [
                    ...
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        (0, j.jsxs)(`label`, {
                          className: `relative flex items-center justify-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-indigo-500 transition-colors`,
                          children: [
                            (0, j.jsx)(`input`, {
                              type: `radio`,
                              name: `userType`,
                            ...
                            (0, j.jsxs)(`div`, {
                              className: `text-center peer-checked:text-indigo-600`,
                              children: [
                                (0, j.jsxs)(`svg`, {
                            ...
                            (0, j.jsx)(`div`, {
                              className: `absolute inset-0 border-2 border-indigo-600 rounded-lg opacity-0 peer-checked:opacity-100`,
                            }),
                          ],
                        }),
                        (0, j.jsxs)(`label`, {
            ...
            ? (0, j.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, j.jsx)(`p`, {
                    ...
                    children: `Nous avons envoyé un lien de réinitialisation à votre adresse email. Vérifiez votre boîte de réception et vos spams.`,
                  }),
                  (0, j.jsxs)(`div`, {
                    className: `space-y-3`,
                    children: [
...
function An({ userType: e }) {
  let [t, n] = (0, x.useState)([
      {
        id: 1,
        title: `Finir les exercices de mathématiques`,
        status: `en cours`,
        priority: `high`,
      },
      {
  ...
  return (0, j.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, j.jsxs)(`div`, {
        ...
        children: [
          (0, j.jsxs)(`div`, {
            className: `grid grid-cols-1 min-[900px]:grid-cols-3 gap-6 mb-6`,
            children: [
              (0, j.jsx)(on, {
                to: `/chat`,
                className: `bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 md:p-6 border border-gray-200 relative`,
                children: (0, j.jsxs)(`div`, {
                  className: `flex items-center gap-3 md:gap-4`,
                  children: [
                    (0, j.jsxs)(`div`, {
                      className: `w-10 h-10 md:w-12 md:h-12 bg-indigo-100 rounded-lg flex items-center justify-center flex-shrink-0 relative`,
                      children: [
                        (0, j.jsx)(`svg`, {
              ...
              (0, j.jsx)(on, {
                to: `/tasks`,
                className: `bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-4 md:p-6 border border-gray-200`,
                children: (0, j.jsxs)(`div`, {
                  className: `flex items-center gap-3 md:gap-4`,
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `w-10 h-10 md:w-12 md:h-12 bg-amber-100 rounded-lg flex items-center justify-center flex-shrink-0`,
                      children: (0, j.jsx)(`svg`, {
              ...
              (0, j.jsx)(on, {
                ...
                children: (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `w-10 h-10 md:w-12 md:h-12 bg-emerald-100 rounded-lg flex items-center justify-center flex-shrink-0`,
                      children: (0, j.jsx)(`svg`, {
                ...
                children: [
                  ...
                  (0, j.jsxs)(`div`, {
                    children: [
                      ...
                      (0, j.jsx)(`p`, {
                        className: `text-xs text-gray-500`,
                        children: `Organiser votre travail`,
                      }),
                    ],
                  }),
                ],
...
function jn({ userType: e }) {
  ...
  let f =
    ...
    p = (e) => {
      let t = e.target.value,
        n = f.find((e) => e.id === t);
      n && !u.find((e) => e.id === t) && d([...u, n]), (e.target.value = ``);
    },
    m = (e) => {
      d(u.filter((t) => t.id !== e));
    },
  ...
  return (0, j.jsxs)(`div`, {
    ...
    children: [
            ...
            children: [
                  ...
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`button`, {
                        onClick: () =>
                          alert(
                            `Sélectionnez un contact puis cliquez ici pour le supprimer`
                          ),
              ...
              (0, j.jsxs)(`button`, {
                ...
                children: [
                  ...
                  (0, j.jsx)(`span`, { children: `Nouveau message` }),
                ],
              }),
            ],
          }),
                        ...
                        children: [
                          ...
                          (0, j.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              e.unread > 0 &&
                                (0, j.jsx)(`span`, {
                                  className: `ml-2 inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-indigo-600 rounded-full`,
                                  children: e.unread,
                                }),
                            ],
                          }),
      ...
      (0, j.jsx)(`div`, {
        className: `flex flex-col flex-1 ${c ? `hidden md:flex` : ``}`,
        children: _
          ? (0, j.jsxs)(j.Fragment, {
              children: [
                (0, j.jsx)(`div`, {
                        ...
                        children: [
                          ...
                          (0, j.jsxs)(`div`, {
                            children: [
                              ...
                              (0, j.jsx)(`p`, {
                                className: `text-xs text-gray-500`,
                                children: _.online ? `En ligne` : `Hors ligne`,
                              }),
                            ],
                          }),
                        ],
                ...
                (0, j.jsx)(`div`, {
                  ...
                  children: g.map((e) =>
                    (0, j.jsx)(
                      ...
                      {
                        className: `flex ${
                          e.sender === `me` ? `justify-end` : `justify-start`
                        }`,
                        children: (0, j.jsxs)(`div`, {
                      ...
                      (0, j.jsxs)(`select`, {
                        ...
                        children: [
                          (0, j.jsx)(`option`, {
                            value: ``,
                            disabled: !0,
                            children: `Sélectionner un contact...`,
                          }),
                          f.map((e) =>
                            (0, j.jsx)(
                              `option`,
...
function Mn({ userType: e }) {
  let t = A(),
    [n, r] = (0, x.useState)(new Date()),
    [i, a] = (0, x.useState)(!1),
    [o, s] = (0, x.useState)(null),
    [c, l] = (0, x.useState)(null),
    [u, d] = (0, x.useState)([]);
  (0, x.useEffect)(() => {
    t.state?.openModal && a(!0);
  }, [t]);
  let f =
      e === `student`
    ...
    p = (e) => {
      let t = e.target.value;
      t && !u.includes(t) && d([...u, t]), (e.target.value = ``);
    },
    m = (e) => {
      d(u.filter((t) => t !== e));
    },
    ...
    g = (e) => {
      let t = e.getFullYear(),
        ...
        a = r.getDay(),
        o = [];
      for (let e = 0; e < a; e++) o.push({ day: null, isCurrentMonth: !1 });
      for (let e = 1; e <= i; e++) {
        let r = `${t}-${String(n + 1).padStart(2, `0`)}-${String(e).padStart(
            2,
            `0`
          )}`,
          i = h.filter((e) => e.date === r);
        o.push({
          day: e,
          isCurrentMonth: !0,
          date: r,
          events: i,
          isToday:
            new Date().toDateString() === new Date(t, n, e).toDateString(),
        });
      }
      return o;
    },
          ...
          children: [
            (0, j.jsxs)(`div`, {
              children: [
                ...
                (0, j.jsx)(`p`, {
                  className: `text-gray-600 mt-1`,
                  children: `Gérez vos rendez-vous et événements`,
                }),
              ],
            }),
            (0, j.jsxs)(`button`, {
              ...
              children: [
                ...
                (0, j.jsx)(`span`, { children: `Nouvel événement` }),
              ],
            }),
          ],
        }),
              ...
              children: [
                (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    (0, j.jsxs)(`h2`, {
                      className: `text-xl font-bold text-gray-900`,
                      children: [_[n.getMonth()], ` `, n.getFullYear()],
                    }),
                    (0, j.jsxs)(`div`, {
                        ...
                        `div`,
                        {
                          className: `min-h-24 p-2 border border-gray-200 rounded-lg ${
                            e.isCurrentMonth
                              ...
                              : `bg-gray-50`
                          } ${e.isToday ? `ring-2 ring-indigo-600` : ``}`,
                          children:
                            e.day &&
                            (0, j.jsxs)(j.Fragment, {
                              children: [
                                ...
                                (0, j.jsx)(`div`, {
                                  ...
                                  children: e.events?.map((e) =>
                                    (0, j.jsx)(
                                      ...
                                      {
                                        onClick: () => s(e),
                                        className: `text-xs p-1 rounded bg-${e.color}-100 text-${e.color}-700 truncate hover:bg-${e.color}-200 transition-colors text-left w-full`,
                                        children: e.time,
                                      },
                                      e.id
                                    )
                      ...
                      `div`,
                      {
                        ...
                        children: [
                          (0, j.jsxs)(`div`, {
                            ...
                            children: [
                              (0, j.jsx)(`div`, {
                                className: `w-3 h-3 rounded-full bg-${e.color}-500 mt-1`,
                              }),
                              (0, j.jsxs)(`div`, {
                                className: `relative`,
                                children: [
                      ...
                      (0, j.jsxs)(`select`, {
                        ...
                        children: [
                          (0, j.jsx)(`option`, {
                            value: ``,
                            disabled: !0,
                            children: `Sélectionner un participant...`,
                          }),
                          f.map((e) =>
                            (0, j.jsx)(`option`, { value: e, children: e }, e)
                          ),
                        ],
                      }),
                      u.length > 0 &&
                ...
                children: [
                  ...
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`span`, {
                        children: new Date(o.date).toLocaleDateString(`fr-FR`, {
                          weekday: `long`,
                          day: `numeric`,
                          month: `long`,
                          year: `numeric`,
                    ...
                    (0, j.jsxs)(`div`, {
                      children: [
                        ...
                        (0, j.jsx)(`div`, {
                          ...
                          children: o.participants.map((e, t) =>
                            (0, j.jsx)(
                              `span`,
                              {
...
function Nn({ userType: e }) {
  let t = A(),
    [n, r] = (0, x.useState)(`all`),
    [i, a] = (0, x.useState)(!1),
    [o, s] = (0, x.useState)(null),
    [c, l] = (0, x.useState)({});
  (0, x.useEffect)(() => {
  ...
  let [u, d] = (0, x.useState)([
    ...
    g = (t, n) => {
      e === `student`
        ? d(u.map((e) => (e.id === t ? { ...e, status: n } : e)))
        : p(f.map((e) => (e.id === t ? { ...e, status: n } : e)));
    },
    _ = h.filter((e) => (n === `all` ? !0 : e.status === n)),
    v = (e) => {
      switch (e) {
        case `high`:
          return `red`;
          ...
          children: [
            (0, j.jsxs)(`div`, {
              children: [
                ...
                (0, j.jsx)(`p`, {
                  className: `text-gray-600 mt-1`,
                  children: `Organisez votre travail scolaire`,
                }),
              ],
            }),
            (0, j.jsxs)(`button`, {
              ...
              children: [
                ...
                (0, j.jsx)(`span`, { children: `Nouvelle tâche` }),
              ],
            }),
          ],
        }),
          ...
          (0, j.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, j.jsxs)(`button`, {
                ...
                children: [
                  `À faire (`,
                  h.filter((e) => e.status === `todo`).length,
                  `)`,
                ],
              }),
              (0, j.jsxs)(`button`, {
                onClick: () => r(`inProgress`),
                className: `px-4 py-2 rounded-lg font-medium transition-colors ${
                  n === `inProgress`
                    ? `bg-indigo-600 text-white`
                    : `bg-white text-gray-700 border border-gray-200 hover:bg-gray-50`
                ...
                children: [
                  `En cours (`,
                  h.filter((e) => e.status === `inProgress`).length,
                  `)`,
                ],
              }),
              (0, j.jsxs)(`button`, {
                ...
                children: [
                  `Terminées (`,
                  h.filter((e) => e.status === `done`).length,
                  `)`,
                ],
              }),
            ],
              ...
              _.length > 0
                              ...
                              children: [
                                ...
                                (0, j.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, j.jsxs)(`span`, {
                                      className: `inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-${v(
                                        e.priority
                                      )}-100 text-${v(e.priority)}-700`,
                                      children: [`Priorité `, y(e.priority)],
                                    }),
                                    (0, j.jsxs)(`span`, {
                                    ...
                                    e.assignedBy &&
                                      (0, j.jsxs)(`span`, {
                                        className: `inline-flex items-center space-x-1 text-xs text-indigo-600 bg-indigo-50 px-2 py-1 rounded-full`,
                                        children: [
                                          (0, j.jsx)(`svg`, {
                                            className: `w-4 h-4`,
                                            fill: `none`,
                            ...
                            (0, j.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, j.jsx)(`button`, {
                                  ...
                                  title: e.assignedBy ? `Soumettre` : `Terminé`,
                                  children: e.assignedBy
                                    ? (0, j.jsx)(`svg`, {
                                        className: `w-5 h-5`,
                                        fill: `none`,
                                        stroke: `currentColor`,
                ...
                : (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`p`, {
                        className: `text-gray-500`,
                        children: `Aucune tâche dans cette catégorie`,
                      }),
                    ],
                  }),
          }),
                            ...
                            (0, j.jsxs)(`div`, {
                              ...
                              children: [
                                (0, j.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, j.jsx)(`span`, {
                                      className: `inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-indigo-100 text-indigo-700`,
                    ...
                    (0, j.jsxs)(`div`, {
                      children: [
                        ...
                        (0, j.jsxs)(`select`, {
                          className: `w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500`,
                          children: [
                            (0, j.jsx)(`option`, { children: `Moi-même` }),
                            (0, j.jsx)(`option`, { children: `Thomas Martin` }),
                            (0, j.jsx)(`option`, { children: `Emma Rousseau` }),
                            (0, j.jsx)(`option`, { children: `Lucas Bernard` }),
                          ],
                        }),
                      ],
                    }),
...
function Pn({ userType: e, onLogout: t }) {
  let n = A(),
    r = [
      {
                  ...
                  (0, j.jsxs)(`div`, {
                    children: [
                      ...
                      (0, j.jsx)(`p`, {
                        ...
                        children: e === `student` ? `Élève` : `Bénévole`,
                      }),
                    ],
                  }),
                ],
            ...
            children: r.map((e) => {
              ...
              return (0, j.jsxs)(
                on,
                {
                  ...
                  children: [e.icon, (0, j.jsx)(`span`, { children: e.name })],
                },
                e.path
              );
            }),
          ...
          (0, j.jsx)(`div`, {
            ...
            children: (0, j.jsxs)(`button`, {
              ...
              children: [
                ...
                (0, j.jsx)(`span`, { children: `Déconnexion` }),
              ],
            }),
          }),
        ],
              ...
              return (0, j.jsxs)(
                on,
                {
                  ...
                  className: `flex flex-col items-center justify-center flex-1 h-full space-y-1 ${
                    t ? `text-indigo-600` : `text-gray-400`
                  }`,
                  children: [
                    e.icon,
                    (0, j.jsx)(`span`, {
      ...
      children: e
        ? (0, j.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, j.jsx)(`div`, {
                ...
                children: (0, j.jsxs)(yt, {
                  children: [
                    (0, j.jsx)(_t, {
                      path: `/dashboard`,
                      element: (0, j.jsx)(An, { userType: n }),
                    }),
                    (0, j.jsx)(_t, {
                      path: `/chat`,
                      element: (0, j.jsx)(jn, { userType: n }),
                    }),
                    (0, j.jsx)(_t, {
                      path: `/calendar`,
                      element: (0, j.jsx)(Mn, { userType: n }),
                    }),
                    (0, j.jsx)(_t, {
                      path: `/tasks`,
                      element: (0, j.jsx)(Nn, { userType: n }),
                    }),
                    (0, j.jsx)(_t, {
                      path: `*`,
                      element: (0, j.jsx)(gt, {
        ...
        : (0, j.jsxs)(yt, {
            children: [
              ...
              (0, j.jsx)(_t, { path: `/signup`, element: (0, j.jsx)(On, {}) }),
              (0, j.jsx)(_t, {
              ...
              (0, j.jsx)(_t, {
                path: `*`,
                element: (0, j.jsx)(gt, { to: `/login`, replace: !0 }),
              }),
            ],
          }),
    }),
...
var In = Fn;
En.createRoot(document.getElementById(`root`)).render(
  (0, j.jsx)(x.StrictMode, { children: (0, j.jsx)(In, {}) })
);
